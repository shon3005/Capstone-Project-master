...
class EditProfileViewController: UIViewController, UITextFieldDelegate, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidAppear(animated: Bool) {
        ...
        println(self.profile?.website)
        println(self.profile?.aboutMe)
    }
    ...
    override func viewDidLoad() {
        ...
        button.frame = CGRectMake(250, 75, 100, 30)
        //button.backgroundColor = UIColor.greenColor()
        button.setTitle("Edit Photo", forState: UIControlState.Normal)
